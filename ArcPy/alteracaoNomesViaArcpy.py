...
shp = "C:\Users\Documents\UnidadesConservacao.shp"  #inserir endereço da camada

nome = 'teste' #inserir nome do campo a ser copiado

expressao = 'Campo(!nome!)'  #alterar o nome do campo de referência
